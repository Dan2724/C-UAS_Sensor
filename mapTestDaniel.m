...
UAS1 = UAS(18, [0, 0], asset2.location, 'Linear'); % Define UAS (speed, entrance, target, mode)
...
sim = simulator(map, AOR, UAS1, [sensor1, sensor2], [asset1, asset2], tps=20, animate=true, nfzs=[NFZ1, NFZ2], animationMultiplier=10); % Define simulator (map, UASs, Assets, Dt, Animate T/F, NFZs)
